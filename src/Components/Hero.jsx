...
// import PPic from '../assets/ats.jpeg';
...
//           I&apos;m a Full Stack Developer & Ui/Ux Designer residing in India with a strong passion for web development and designing. Pouring my passion into crafting engaging web applications & design.
//         </p>
...
//             </Button>
//           </Link>
//           <a href="https://drive.google.com/file/d/1YmZiqO3GjY0F_zmMdOYdftldk65yxJUp/view?usp=sharing" target="_blank" rel="noreferrer">
//             <Button variant="gradient" color="red" className="flex gap-2 items-center">
...
import { useDarkMode, ThemeIcon } from '../DarkModeContext'; // Adjust the path as necessary
import PPic from '../assets/ats.jpeg';
import IndianFlagPNG from '../assets/indian.png'; // Adjust the path to the PNG file
  ...
  return (
    <div className={`pb-16 lg:py-25 min-h-screen flex items-center flex-col-reverse lg:flex-row gap-1 justify-center ${darkMode ? "dark" : ""}`}>
      <div className="flex flex-col gap-2 md:gap-6 text-left lg:w-1/2 2xl:w-1/3 mx-6 xl:mx-0 ">
        ...
        <p className="text-lg md:text-l font-medium relative">
          I&apos;m a Full Stack Developer & Ui/Ux Designer residing in <span className="inline-flex items-center"><img src={IndianFlagPNG} alt="Indian Flag" className="h-3 w-auto" />INDIA</span> with a strong passion for web development and designing. Pouring my passion into crafting engaging web applications & design.
        </p>
